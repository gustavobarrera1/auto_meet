...
def run():
    ...
    wb.register("edge",None,wb.BackgroundBrowser("C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe"))
    ...
    pyto.sleep(1)
    pyto.click(1260,540) # entrar a la clase #dependiendo de la resolucion tenes que cambiar este parametro
    pyto.hotkey('F11')
